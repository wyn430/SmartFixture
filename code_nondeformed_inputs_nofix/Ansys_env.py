...
class Env:
    ...
    def __init__(self, original_input_filename, input_filename, initial_fixture_locations, max_num, thresh, ip, port):
        ...
        self.bottom_index, self.bottom_surface_nodes, self.bottom_displacement, self.bottom_stress = self.get_results(input_filename)
    ...
    def reset(self, initial_fixture_locations, original_input_filename, input_filename):
    ...
    def step(self, action2, original_input_filename, input_filename, quant_lim):
    ...
    @timeout(30)
    def remote_run(self, input_filename):
    ...
    def get_results(self, input_filename):
        
        try:
            bottom_index, bottom_surface_nodes, bottom_displacement, bottom_stress = self.remote_run(input_filename)
